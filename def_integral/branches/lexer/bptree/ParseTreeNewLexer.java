 ...
 *
 */
public class ParseTreeNewLexer implements Calculate {
	...
	public static ParseTreeNewLexer makeTree(String expression,boolean optimize) throws ParseTreeGenerationException
	{
		return new ParseTreeNewLexer(expression,optimize);
	}
	 ...
	 */
	private ParseTreeNewLexer(String expression) throws ParseTreeGenerationException {
	 ...
	 * @throws ParseTreeGenerationException 
	 */
	private ParseTreeNewLexer(String expression, boolean optimize) throws ParseTreeGenerationException
	{
